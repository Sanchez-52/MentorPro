...
public class estudianteInsert extends javax.swing.JFrame {

    private Long codEstudiante = 0L;
    ...
    public void setEstudiante(Estudiante stud) {
        codEstudiante = stud.getCodEstudiante();
        nombreTxt.setText(stud.getNombre());
        apellidoTxt.setText(stud.getApellido());
        dniTxt.setText(stud.getDni());
        dniTxt.setEnabled(false);
        direccionTxt.setText(stud.getDireccion());
        correoTxt.setText(stud.getCorreo());
        verificarExistenciaBtn.setEnabled(false);
        eliminarBtn.setVisible(true);
        tituloLabel.setText("Modificar Estudiante");
    }
    ...
    private void initComponents() {
        ...
        tituloLabel.setText("Agregar Estudiante");
    ...
    private void verificarExistenciaBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verificarExistenciaBtnActionPerformed
        ...
        boolean existeEstudiante = controller.existeEstudiantePorDni(dni);

        // Si se encuentra un estudiante con el mismo dni, muestra una alerta
        if (existeEstudiante) {
            JOptionPane.showMessageDialog(null, "El estudiante con DNI: " + dni + " ya está registrado.", "Alerta", JOptionPane.WARNING_MESSAGE);
            this.setVisible(false);
            estudiantesManage estudianteManageView = new estudiantesManage();
            estudianteManageView.setVisible(true);
            estudianteManageView.setLocationRelativeTo(null);
        } else {
    ...
    private void confirmarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarBtnActionPerformed
        ...
        if (!passwordTxt.getText().equals(confirmPasswordTxt.getText())) {
            ...
            JOptionPane.showMessageDialog(estudianteInsert.this, "Las contraseñas no coinciden", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            if (codEstudiante != 0) {
                ...
                estudiante.setNombre(nombreTxt.getText());
                estudiante.setApellido(apellidoTxt.getText());
                estudiante.setDni(dniTxt.getText());
                estudiante.setDireccion(direccionTxt.getText());
                estudiante.setCorreo(correoTxt.getText());
                String passwordHash = hash(passwordTxt.getText());
                estudiante.setPasswordHash(passwordHash);
                ...
                JOptionPane.showMessageDialog(null, "El estudiante se ha modificado con éxito.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(null, "El estudiante se ha creado con éxito.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            }
            this.setVisible(false);
            estudiantesManage estudianteManageView = new estudiantesManage();
            estudianteManageView.setVisible(true);
    ...
    private void eliminarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarBtnActionPerformed
        ...
        if (opcion == JOptionPane.YES_OPTION) {
            ...
            //Se inicia el controlador
            EstudianteController controller = new EstudianteController();
            controller.eliminarEstudiante(codEstudiante);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(estudianteInsert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new estudianteInsert().setVisible(true);
            }
        });
    }
